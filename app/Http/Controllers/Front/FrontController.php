...
class FrontController extends Controller
{
    ...
    public function builder(): void
    {
        ...
        $homePage->content = $homePage->getContent(["content_type" => Page::CONTENT_TYPE_VIEW, "view_path" => "front.home"]);
